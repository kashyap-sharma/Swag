...
public class ParticleSystemRenderer implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig eglConfig) {
        ...
        final String vertexShader = RawResourceReader.readTextFileFromRawResource(appContext, R.raw.star_vert);
        final String fragmentShader = RawResourceReader.readTextFileFromRawResource(appContext, R.raw.star_frag);
